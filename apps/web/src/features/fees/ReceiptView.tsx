  ...
  return (
    <div className="max-w-2xl mx-auto bg-surface/30 min-h-screen py-12 px-6 animate-fade-in">
      ...
      <div className="mint-card p-0 overflow-hidden bg-canvas shadow-premium print:shadow-none print:border-hairline">
        ...
        <div className="hero-backdrop-revenue p-4 sm:p-10 text-center border-b border-hairline">
        ...
        <div className="p-12">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-8 mb-12 p-3 sm:p-8 bg-surface/30 rounded-lg border border-hairline">
