        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 sm:gap-8">
          ...
          <div className="flex flex-wrap items-center gap-4">
             ...
             <button 
               ...
               className="h-14 px-4 sm:px-8 bg-canvas border border-hairline text-ink hover:bg-surface rounded-2xl text-[10px] font-black uppercase tracking-widest flex items-center transition-all shadow-sm group"
             >
        ...
        <div className="divide-y divide-hairline">
          {filteredStaff.length === 0 ? (
            ...
            filteredStaff.map((member) => {
              ...
              return (
                <div key={member.id} className={`flex flex-col lg:flex-row lg:items-center justify-between p-4 sm:p-8 gap-4 sm:gap-8 transition-all ${currentStatus ? 'bg-surface/40' : 'hover:bg-surface/20'}`}>
